...
//
// The faction (protocol 24), door (26), placed-building-door (28), deed (54)
// and fixture (55) channels are SYMMETRIC: both clients publish rows for the
// SAME key, each stamping its own independent seq counter (facSeqOut_/
// doorSeqOut_/bdoorSeqOut_/deedSeqOut_/fixtureSeqOut_). The
...
// deed/fixture rows migrated 2026-09-24, MP-P-15).
...
// Replicator::applyFactions / applyDoors / applyBuildDoors / applyDeeds /
// applyFixtures in ReplicatorChannels.cpp.
