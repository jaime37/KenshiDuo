...
public:
    ...
    // Protocol 61 pre-save fence (join side): latch a host request. The ordinary
    ...
    // BEFORE engine (protocol 62, HOST only - the witness authority settled by
    ...
    // BEFORE engine (protocol 62, client side): drain received bounty rows;
...
private:
    ...
    struct Driven {
        ...
        // this body by a RELIABLE edge (an applied canonical FURNITURE_STATE
        // row, protocol 59; 0 = none, cleared on a canonical release / the
        ...
        // edge-vouched cage every tick (the 75-885 u re-seat teleport).
        int           furnEdgeKind;
    ...
    // Protocol 62 bounty/crime rows, keyed by (owning-character hand, faction
